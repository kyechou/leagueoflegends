...
Installed-Size: $SIZE
Depends: wine-lol, winetricks, bash, curl, openssl, winbind, libgnutls30, libldap, libopenal1, libpulse0, libasound2, libodbc1, libvkd3d1, libvulkan1, mesa-vulkan-drivers
Suggests: zenity
Priority: optional
